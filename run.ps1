# Knot Garden MVP Monolith Launcher
...
Write-Host "  Knot Garden MVP Monolith Dev Environment" -ForegroundColor Cyan
Write-Host "=============================================" -ForegroundColor Cyan
...
Start-Process powershell -WorkingDirectory $BackendDir -ArgumentList "-NoExit", "-Command", "dotnet run --project KnotGarden.Api/KnotGarden.Api.csproj --launch-profile http" -WindowStyle Normal
