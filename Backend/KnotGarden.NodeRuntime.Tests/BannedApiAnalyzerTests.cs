...
public class BannedApiAnalyzerTests
{
    ...
    public void Analyze_WithBannedUsing_ReturnsBannedApiDiagnostic(string bannedUsing)
    {
        ...
        var code = $@"
            ...
            {{
                public System.Threading.Tasks.ValueTask<KnotGarden.Core.Contracts.NodeResult> ExecuteAsync(
                    KnotGarden.Core.Contracts.NodeInput input, 
                    KnotGarden.Core.Contracts.INodeContext context, 
    ...
    public void Analyze_WithStaticReadonlyOrConstOutsideExecutor_IsAllowed()
    {
        ...
        var helperCode = @"
            ...
            {
                public const string AppName = ""KnotGarden"";
