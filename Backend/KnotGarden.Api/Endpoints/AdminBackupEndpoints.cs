...
public static class AdminBackupEndpoints
{
    public static void MapAdminBackupEndpoints(this WebApplication app)
    {
        ...
        app.MapPost("/api/admin/backup", async (
            ...
            KnotGarden.Features.Backup.BackupService backupService,
            CancellationToken cancellationToken) =>
        {
            ...
            catch (KnotGarden.Features.Backup.BackupArchiveException ex)
            {
            ...
            CancellationToken cancellationToken) =>
        {
            ...
            catch (KnotGarden.Features.Backup.BackupIncompatibleException ex)
            {
            ...
            CancellationToken cancellationToken) =>
        {
            ...
            catch (KnotGarden.Features.Backup.BackupRestoreBlockedException ex)
            {
                var statusCode = ex.Reason == KnotGarden.Features.Backup.RestoreBlockReason.RuntimeArmed
