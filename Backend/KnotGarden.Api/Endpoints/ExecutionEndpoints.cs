...
public static class ExecutionEndpoints
{
    ...
    {
        app.MapPost("/api/executions", async (StartExecutionRequest request, IWorkflowStore workflowStore, ExecutionStarter executionStarter, ActiveWorkflowVersionService activeWorkflowVersionService, KnotGarden.Api.Services.RuntimeArmingState armingState) =>
        {
        ...
        {
            var headerToken = httpRequest.Headers["X-KnotGarden-Token"].FirstOrDefault();
        ...
        app.MapPost("/api/workflows/{id}/condition-values", async (string id, ConditionValuesRequest request, AppDbContext db) =>
        {
            ...
            var resolved = KnotGarden.Features.Nodes.Condition.ConditionLastRunResolver.Resolve(
