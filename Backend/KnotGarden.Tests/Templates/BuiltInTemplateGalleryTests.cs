...
using KnotGarden.Tests.Compiler;
using Xunit;
...
public class BuiltInTemplateGalleryTests
{
    ...
    private static string ShippedSourcesDirectory()
    {
        ...
        {
            var candidate = Path.Combine(directory.FullName, "KnotGarden.Api", "Templates", "Sources");
        ...
        throw new DirectoryNotFoundException("Could not locate KnotGarden.Api/Templates/Sources from the test output.");
    }
