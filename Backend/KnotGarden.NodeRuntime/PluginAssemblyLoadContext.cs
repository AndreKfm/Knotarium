...
///
/// Strategy: assemblies the host already provides (KnotGarden.*, Microsoft.Extensions.*, System.*)
...
internal sealed class PluginAssemblyLoadContext : AssemblyLoadContext
{
    ...
    private static bool IsHostShared(string assemblyName)
        => assemblyName.StartsWith("KnotGarden.", StringComparison.OrdinalIgnoreCase)
