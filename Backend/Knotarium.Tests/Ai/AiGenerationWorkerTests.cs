...
public class AiGenerationWorkerTests
{
    private sealed class FakeRunner : IAiGenerationRunner
    {
        ...
        public Task<AiGenerationRunResult> RunAsync(string intent, CancellationToken cancellationToken = default, Knotarium.Core.Domain.WorkflowDefinition? currentWorkflow = null)
