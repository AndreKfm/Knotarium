...
namespace KnotGarden.Features.Compiler;
...
public class WorkflowCompiler
{
    ...
    public async Task<CompilationResult> CompileAsync(WorkflowDefinition definition, CancellationToken cancellationToken = default)
    {
        ...
        foreach (var edge in flatEdges)
        {
            ...
            const string ExternalDeviceType = KnotGarden.Core.Reactive.ReactiveRuleCompiler.ExternalDeviceNodeType;
        ...
        var hasDeviceNodes = flatNodes.Any(n =>
            string.Equals(n.Type, KnotGarden.Core.Reactive.ReactiveRuleCompiler.ExternalDeviceNodeType, StringComparison.OrdinalIgnoreCase));
