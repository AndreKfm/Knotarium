...
public class ManifestConformanceTests
{
    ...
    public void At_least_the_extracted_leaf_projects_are_present()
    {
        ...
        foreach (var expected in new[]
                 {
                     "Knotarium.Core", "Knotarium.Features",
                     "Knotarium.Features.Options", "Knotarium.Features.NodeEditor", "Knotarium.Features.Compiler",
                     "Knotarium.Features.Settings", "Knotarium.Features.Condition", "Knotarium.Features.OpenApi",
                     "Knotarium.Features.Portability", "Knotarium.Features.Ai",
                 })
