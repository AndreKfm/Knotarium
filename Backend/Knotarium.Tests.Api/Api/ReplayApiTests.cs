...
public sealed class ReplayApiTests : IClassFixture<KnotariumApiFactory>, IDisposable
{
    private readonly WebApplicationFactory<Program> _factory;
    private readonly string _databasePath;

    public ReplayApiTests(KnotariumApiFactory factory)
    {
        _databasePath = Path.Combine(Path.GetTempPath(), $"knotarium-replay-tests-{Guid.NewGuid():N}.db");
