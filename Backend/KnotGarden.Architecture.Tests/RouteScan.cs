...
/// <summary>
/// Source-text scan of the KnotGarden.Api project for minimal-API route registrations.
...
internal static class RouteScan
{
    ...
    /// <summary>Absolute path to the KnotGarden.Api project directory.</summary>
    public static string ApiProjectDir => Path.Combine(ModuleManifest.BackendRoot(), "KnotGarden.Api");
