...
/// <summary>
/// IL-level (Mono.Cecil via NetArchTest) queries over the KnotGarden.Features assembly.
...
{
    /// <summary>The feature slices still living inside the single KnotGarden.Features assembly.</summary>
    ...
    public static Assembly FeaturesAssembly => typeof(KnotGarden.Features.Nodes.InlineCodeNodeTask).Assembly;

    private static string Ns(string slice) => $"KnotGarden.Features.{slice}";
    ...
    {
        const string appDbContext = "KnotGarden.Infrastructure.Persistence.AppDbContext";
