...
Primary drift authority: `Backend/KnotGarden.Features/module.yaml` (`slice_rules.baseline_appdbcontext_users`) enforced by `Backend/KnotGarden.Architecture.Tests/SliceBoundaryTests.cs`
