...
Open **http://localhost:8080**. On first run you create an admin account. The SQLite database persists in the `knotgarden-data` volume.
...
| `Database__ConnectionString` | Defaults to `Data Source=/data/KnotGarden.db` in Docker. |
