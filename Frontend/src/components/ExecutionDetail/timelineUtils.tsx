...
// Failed(5), Discarded(7). Kept in sync with Backend/KnotGarden.Core/Domain/ExecutionStatus.cs.
...
// in the header pill. Kept in sync with Backend/KnotGarden.Core/Domain/ExecutionStatus.cs.
