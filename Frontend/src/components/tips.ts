...
export const TIPS: Tip[] = [
  ...
  { text: 'Inline-code and database nodes are off by default. Enable them under Settings → Capabilities only for instances you trust.' },
  { text: 'File Read/Write is deny-by-default — grant specific folders under Settings → File Access.' },
  { text: 'Publish a version, then Activate it: triggers use the active version while manual runs use what you’re editing.' },
