...
// Palette (Knotarium dark/cyan language, per the import-redesign spec).
const C = {
    ...
    <div style={{ maxWidth: wide ? 1180 : 880, margin: '0 auto', color: C.ink }}>
      ...
      <div className="phead" style={{ marginBottom: 4 }}>
        ...
        <p style={{ color: C.muted, maxWidth: 640 }}>
          Upload a vendor configuration file to generate Knotarium workflows. They're created as <b style={{ color: C.ink }}>inactive drafts</b> — review the coverage report, then publish &amp; arm them when you're ready.
        </p>
      </div>
  ...
  return (
    <>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: 14, marginTop: 16 }}>
        {[
          { ic: TI.upload({ width: 16, height: 16 }), n: 'STEP 1', t: 'Upload & translate', d: 'We parse the vendor file and map every event and action onto Knotarium constructs.' },
