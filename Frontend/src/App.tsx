...
const NAVIGATION_STATE_STORAGE_KEY = 'knotgarden-navigation-state';
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '12px', cursor: 'pointer' }} onClick={navigateToDashboard}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', lineHeight: 1.15 }}>
            <span style={{ fontWeight: 800, fontSize: '1.25rem', letterSpacing: '0.05em', color: '#fff' }}>
              KNOT GARDEN<span style={{ color: 'var(--color-accent)', textShadow: '0 0 10px var(--color-accent-glow)' }}>.</span>
            </span>
            {version && (
              <span
