...
#
# Multi-stage build for KnotGarden: build the React UI, publish the .NET backend, then
...
RUN dotnet publish Backend/KnotGarden.Api/KnotGarden.Api.csproj \
      -c Release \
...
ENV ASPNETCORE_ENVIRONMENT=Production \
    ...
    Database__ConnectionString="Data Source=/data/KnotGarden.db"
...
EXPOSE 8080
ENTRYPOINT ["dotnet", "KnotGarden.Api.dll"]
