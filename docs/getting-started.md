...
If you haven't started KnotGarden yet, see the [Quickstart in the README](../README.md#quickstart-docker).
...
KnotGarden can **execute code and touch the filesystem**, so a few powerful features are locked
down by default:
