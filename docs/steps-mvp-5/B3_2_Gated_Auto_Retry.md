...
### 2. Update failure handler in [WorkflowExecutor.cs](file:///d:/Private/Source/AknSideProjects/Automate/Backend/KnotGarden.Features/Execution/WorkflowExecutor.cs) [MODIFY]
```csharp
