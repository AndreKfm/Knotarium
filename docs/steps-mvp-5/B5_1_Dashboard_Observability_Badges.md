...
### 2. Implement Backend manual decision endpoint in [ExecutionsController.cs](file:///d:/Private/Source/AknSideProjects/Automate/Backend/Knotarium.Api/Controllers/ExecutionsController.cs) [NEW]
