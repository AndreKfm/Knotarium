...
### 1. Update [DbNodePackageManifestProvider.cs](file:///d:/Private/Source/AknSideProjects/Automate/Backend/Knotarium.Api/DbNodePackageManifestProvider.cs) [MODIFY]
...
* Launch Knotarium (`.\run.ps1`). Confirm no duplicate node listings appear in the palette layout and that custom nodes render successfully.
