...
### 1. Create [NodeRetryState.cs](file:///d:/Private/Source/AknSideProjects/Automate/Backend/Knotarium.Core/NodeRetryState.cs) [NEW]
...
### 3. Implement Lifecycle in [WorkflowExecutor.cs](file:///d:/Private/Source/AknSideProjects/Automate/Backend/Knotarium.Features/Execution/WorkflowExecutor.cs) [MODIFY]
