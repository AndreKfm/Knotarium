...
### 2. Update Compiler Validations in [WorkflowCompiler.cs](file:///d:/Private/Source/AknSideProjects/Automate/Backend/KnotGarden.Core/Compiler/WorkflowCompiler.cs) [MODIFY]
