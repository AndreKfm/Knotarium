...
### `KnotGarden.Infrastructure/Persistence/OpenApi/`
...
In `KnotGarden.Infrastructure/DependencyInjection.cs` (oder wo bestehende Services registriert sind):
```csharp
...
**Datei:** `KnotGarden.Tests/OpenApi/PersistenceTests.cs`
...
- [ ] `dotnet build KnotGarden.Infrastructure` ohne Fehler
- [ ] `dotnet build KnotGarden.Tests` ohne Fehler
