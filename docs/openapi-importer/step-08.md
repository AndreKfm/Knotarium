...
### `KnotGarden.Core/Contracts/OpenApi/IOAuthTokenCache.cs`
...
### `KnotGarden.Infrastructure/OpenApi/InMemoryOAuthTokenCache.cs`
...
**Datei:** `KnotGarden.Tests/OpenApi/OAuthTokenCacheTests.cs`  
Datei erweitern: `KnotGarden.Tests/OpenApi/RestCallerExecutorTests.cs` (OAuth2-Szenarien)
