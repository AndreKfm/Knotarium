...
### `KnotGarden.Features/OpenApi/OpenApiNodeGenerator.cs`
...
**Datei:** `KnotGarden.Tests/OpenApi/NodeGeneratorTests.cs`
...
- [ ] `dotnet build KnotGarden.Features` ohne Fehler
